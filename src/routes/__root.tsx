...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Tehniat Hashir" },
      { property: "og:title", content: "Tehniat Hashir | Full Stack Developer Portfolio" },
      { property: "og:description", content: "Full Stack Developer portfolio showcasing web applications, React projects, project management experience, UI/UX work, and digital solutions." },
